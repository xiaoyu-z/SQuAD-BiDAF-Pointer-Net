...
"""
    We use the preprocessing technique of biDAF from
    https://github.com/allenai/bi-att-flow
    To run the code, need to put the downloaded data into ./dataset and
    put the glove file into the same dataset
